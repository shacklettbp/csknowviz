...
ShaderPipeline::ShaderPipeline(
    ...
    const vector<string> &entry_points,
      ...
      base_pool_sizes_()
{
    ...
    for (int shader_idx = 0; shader_idx < (int)shader_names.size();
         shader_idx++) {
        const auto &shader_name = shader_names[shader_idx];
        const auto &entry_point = entry_points[shader_idx];
